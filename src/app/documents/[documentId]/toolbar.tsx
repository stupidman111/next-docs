  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        px-1.5 overflow-hidden text-sm"
        >
    ...
    <div className="flex items-center gap-x-0.5">
      ...
      {isEditing ? (
        <input
          ...
          className="h-7 w-10 text-sm text-center
        ...
        <button
          ...
          className="h-7 w-10 text-sm text-center
          border border-neutral-400
          rounded-sm bg-transparent cursor-text"
        >
          {currentFontSize}
        </button>
      )}
...
const Toolbar = () => {
  ...
  const sections: {
    ...
    [
      ...
      },
      {
        ...
        onClick: () => {
          const newState = !isSpellCheckActive;
          setIsSpellCheckActive(newState);
          editor?.view.dom.setAttribute("spellcheck", newState.toString());
        },
      },
    ],
    [
  ...
  return (
    <div
      className="bg-[#F1F4F9] px-2.5 py-0.5 rounded-[24px]
    min-h-[40px] flex items-center gap-x-0.5 overflow-x-auto"
    >
      {sections[0].map((item) => (
